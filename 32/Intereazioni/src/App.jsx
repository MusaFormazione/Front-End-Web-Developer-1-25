...
function App() {
  ...
  const vaiAlFondoDelTesto = () => {
    if (testo.current) {
        testo.current.scrollTop = testo.current.scrollHeight;
    }
  }
  ...
  return <div>
    ...
    <div className="container" style={{ padding: '20px' }}>
      <textarea id="testo" ref={testo} contentEditable={true} style={{ width: '80%', height: '300px'}}>
        ...
        ip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
    ...
    {bottoneTopVisibile &&
      <button
        onClick={() => { title.current.scrollIntoView({ behavior: 'smooth' }) }}
        className='btn btn-secondary rounded-circle m-5 position-fixed'
        style={{ top: "80%"}}>
